...
点击仓库页面右上角 **Use this template → Create a new repository**，输入项目名称。

### 2. 初始化配置

克隆仓库后，配置 GitHub Secret：

| Secret 名称 | 获取方式 |
|------------|---------|
| QODER_PERSONAL_ACCESS_TOKEN | [Qoder 设置页](https://qoder.com/settings) 生成 |
...
| 文档 | 说明 |
|------|------|
| [docs/doc-standards.md](docs/doc-standards.md) | 版本规范 — frontmatter 格式、状态流转、变更日志 |
| [docs/templates/](docs/templates/) | 文档模板 — 调研报告、Spec 文档 |
| [docs/model-strategy.md](docs/model-strategy.md) | 模型调度 — 高级/标准模型选择策略 |
